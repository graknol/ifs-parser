...
module.exports = grammar({
  ...
  rules: {
    ...
    table_expression: ($) =>
      prec.right(
        choice(
          seq($.from_target, $.join_clause),
          seq($.from_target, $.alias, $.join_clause),
          // prec(1, seq($.from_target, optional($.alias), repeat1(seq(",", $.from_target, optional($.alias))))),
          // seq($.from_target, $.alias),
          seq($.from_target),
        ),
      ),
